...
*/
	...
	*/
	public function get_news_info($projects_id = 1)
	{
		//TODO//
		$sql = 'SELECT * FROM `project_info` WHERE pid='.$projects_id;
		$query = $this->db->get_where('project_info', array('pid' => $projects_id));
